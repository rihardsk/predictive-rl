...
################################
# soft gradient clipping in get_clip_sgd_updates and get_clip_rmsprop_updates
################################
...
class RecurrentNetwork(PickleMixin, TrainingMixin):
    ...
    def encode(self, X):
        ...
        for n in range(len(X)):
            ...
            enc, state, memory = self._encode(X_n, X_mask)
