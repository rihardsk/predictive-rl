...
basePath=/home/rihards/Programmesana/Multi/rl-library
...
mkdir -p classes
javac -d classes -classpath $GluePath $basePath/SampleExperimentRLGlue-Java-R1306/src/SampleExperiment.java
