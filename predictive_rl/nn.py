...
class NN():
    def __init__(self, nn_layers=None, L2_reg=0.0001, learning_rate=0.1, batch_size=32):
        ...
        self.updates = layers.gen_updates_sgd(self.cost, self.parameters, learning_rate) # the last layer must be a layers.OutputLayer
...
def test_convnet():
    ...
    mlp = NN(nn_layers, batch_size=batch_size)
    """
    ###############
    # TRAIN MODEL #
    ###############
